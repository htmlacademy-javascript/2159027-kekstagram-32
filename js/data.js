...
const PHOTOS_DESCRIPTIONS = [
  ...
  'Моя история, мои правила.',
  'Мечты становятся реальностью!',
  'Жизнь прекрасна, когда ты счастлив!',
  'Каждый день — новый шанс.',
  'Улыбка — лучший аксессуар.',
  'Здесь и сейчас.',
  'Тот самый момент, когда все идеально.',
  'Вдохновляюсь каждым днем.',
  'Лучшее время жизни — это сейчас.',
  'Время летит, но моменты остаются навсегда.',
  'Люблю эту жизнь и её возможности.',
  'Поймала идеальный кадр на закате.',
  'Счастливые моменты стоит запоминать навсегда.'
];
